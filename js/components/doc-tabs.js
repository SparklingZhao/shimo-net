(function () {
  function initDocTabs() {
    var tabContainer = document.querySelector(".collab-tabs");
    if (!tabContainer || tabContainer.dataset.bound === "true") return;

    tabContainer.dataset.bound = "true";
    var tabs = tabContainer.querySelectorAll(".collab-tab");
    var panels = document.querySelectorAll(".collab-panel");
  ...
  window.initDocTabs = initDocTabs;
  initDocTabs();
})();
